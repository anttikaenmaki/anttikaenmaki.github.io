...
{% include theorem.html no="8" theorem="Theorem" info="[K-Rutar (2024+)](https://doi.org/10.48550/arXiv.2410.19404)" %}
...
{% include theorem.html no="9" theorem="Theorem" info="[K-Rutar (2024+)](https://doi.org/10.48550/arXiv.2410.19404)" %}
